                ...
                >
                  ...
                  <div className="p-6 flex flex-col justify-between flex-1">
                    <div className="space-y-2.5">
                      ...
                      <Link 
                        href={`/blog/${post.slug}`}
                        className="font-display text-lg sm:text-xl font-bold text-slate-900 dark:text-white cursor-pointer hover:text-orange-500 dark:hover:text-orange-400 transition-colors duration-150 line-clamp-2 block"
                      >
                        {post.title}
                      </Link>
