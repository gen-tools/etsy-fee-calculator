...
export const metadata: Metadata = {
  title: 'About Us - EtsyFeeCalc E-Commerce Accounting Platform',
  description: 'Discover our team mission, dedication to mathematical accuracy, and custom fee calculating engines optimized to help independent makers scale on Etsy.',
  alternates: {
    canonical: '/about',
  },
};
